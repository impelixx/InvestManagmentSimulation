		...
		<div className='flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100'>
			<div className='max-w-3xl p-8 text-center bg-white rounded-lg shadow-lg'>
				...
				<p className='mb-6 text-lg text-gray-600'>
					...
					сгорают. Готовы бросить вызов рынку и стать настоящим финансовым гением как{' '}
				...
				<div className='flex justify-center space-x-4'>
					...
					<button
						className='px-6 py-3 font-semibold text-white transition bg-gray-500 rounded-lg hover:bg-gray-600'
